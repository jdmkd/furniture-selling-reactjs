(function () {
	...
	function _fncSliderInit(slider, options) {
		...
		let autoSlidingTO;
		let autoSlidingDelay = 4000; // default autosliding delay value
...
// document.querySelector(".fnc-slide__action-btn").addEventListener("click", function () {
